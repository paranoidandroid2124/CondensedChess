...
import lila.commentary.model.authoring.{ AuthorQuestionKind, PlanHypothesis, PlanViability }
      ...
      ActiveStrategicCoachingBriefBuilder.PlannerSurfaceSelection(
        primary =
          QuestionPlan(
            ...
            questionKind = lila.commentary.model.authoring.AuthorQuestionKind.WhyNow,
            priority = 100,
