...
import chess.Color
import lila.commentary.analysis.strategic.{ EndgameAnalyzerImpl, EndgamePatternOracle }
import lila.commentary.model.strategic.{ RookEndgamePattern, TheoreticalOutcomeHint }
