...
import lila.commentary.{ NarrativeSignalDigest, StrategyPack }
...
import lila.commentary.model.authoring.{ AuthorQuestionKind, NarrativeOutline, OutlineBeat, OutlineBeatKind }
