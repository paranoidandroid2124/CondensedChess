...
class ChronicleActivePlannerSliceRunnerTest extends FunSuite:
  ...
  test("SliceSurfaceEntry serializes planner owner trace fields") {
    val replayComposeDebug =
      lila.commentary.analysis.ActiveStrategicCoachingBriefBuilder.DeterministicComposeDebug(
        primaryKind = "WhyNow",
        secondaryKind = None,
        ...
        supportCandidates =
          List(
            lila.commentary.analysis.ActiveStrategicCoachingBriefBuilder.DeterministicSupportCandidate(
              source = "contrast",
    ...
    val entry =
      ChronicleActivePlannerSliceRunner.SliceSurfaceEntry(
        ...
        chronicleSelectedSource = Some("threat"),
        ...
        activeSelectedOwnerKind = Some("MoveDelta"),
        activeSelectedSource = Some("route"),
        ...
        plannerAdmittedOwners = List("ForcingDefense:threat:move_linked"),
        plannerDroppedOwners = List("PlanRace:evidence_backed_plan:missing_certified_race_pair"),
    ...
    assertEquals((js \ "plannerSelectedOwnerKind").asOpt[String], Some("ForcingDefense"))
    assertEquals((js \ "chronicleSelectedOwnerKind").asOpt[String], Some("ForcingDefense"))
    assertEquals((js \ "activeSelectedOwnerKind").asOpt[String], Some("MoveDelta"))
    ...
    val entries =
      List(
        ...
        ChronicleActivePlannerSliceRunner.SliceSurfaceEntry(
          ...
          chronicleSelectedOwnerKind = None,
          chronicleSelectedSource = None,
        ...
        ChronicleActivePlannerSliceRunner.SliceSurfaceEntry(
          ...
          activeSecondaryKind = None,
          activeSelectedOwnerKind = Some("DecisionTiming"),
