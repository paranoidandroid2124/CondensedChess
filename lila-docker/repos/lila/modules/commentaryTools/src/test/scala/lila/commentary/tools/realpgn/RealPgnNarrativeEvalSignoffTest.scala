...
import lila.commentary.analysis.{ CommentaryEngine, StrategyPackSurface }
...
class RealPgnNarrativeEvalSignoffTest extends FunSuite:
  ...
  private def focusMoment(ply: Int, compensationPosition: Boolean) =
    RealPgnNarrativeEvalRunner.FocusMomentReport(
      ...
      moveReviewCompensationPosition = compensationPosition,
      ...
      moveReviewCompensationSubtype = Some("queenside/target_fixing/delayed/durable_pressure"),
      ...
      moveReviewPreparationCompensationSubtype = Some("queenside/target_fixing/delayed/durable_pressure"),
      gameArcPayoffCompensationSubtype = Some("queenside/target_fixing/delayed/durable_pressure"),
      moveReviewPayoffCompensationSubtype = Some("queenside/target_fixing/delayed/durable_pressure"),
      gameArcDisplaySubtypeSource = "path",
      moveReviewDisplaySubtypeSource = "path",
      activeCompensationMention = compensationPosition,
      moveReviewCompensationMention = compensationPosition,
      ...
      moveReviewCommentary = "MoveReview",
