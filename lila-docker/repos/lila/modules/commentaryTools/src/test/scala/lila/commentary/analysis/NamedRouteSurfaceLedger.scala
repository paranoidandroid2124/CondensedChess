...
object NamedRouteSurfaceLedger:
  ...
  private val candidates =
    List(
      Candidate(
        id = "b6_control",
        source = "modules/commentary/tmp/b6-second-survivor-campaign-20260402.md",
      ...
      Candidate(
        id = "b6_k09c",
        source = "StrategicIdeaFenFixtures.K09C / modules/commentary/tmp/b6-second-survivor-campaign-20260402.md",
      ...
      Candidate(
        id = "b6_k09g",
        source = "StrategicIdeaFenFixtures.K09G / modules/commentary/tmp/b6-second-survivor-campaign-20260402.md",
      ...
      Candidate(
        id = "b6_k09h",
        source = "StrategicIdeaFenFixtures.K09H / modules/commentary/tmp/b6-second-survivor-campaign-20260402.md",
      ...
      Candidate(
        id = "b6_b21a",
        source = "StrategicIdeaFenFixtures.B21A / modules/commentary/tmp/b6-second-survivor-campaign-20260402.md",
      ...
      Candidate(
        ...
        source = "modules/commentary/tmp/b7-second-survivor-hunt-20260402.md",
      ...
      Candidate(
        ...
        source =
          "modules/commentary/tmp/frontier-proving-handoff-20260403.md / https://dgriffinchess.wordpress.com/wp-content/uploads/2021/09/karpov-kavalek-21st-olympiad-nice-1974.pdf",
      ...
      Candidate(
        ...
        source =
          "modules/commentary/tmp/frontier-proving-handoff-20260403.md / https://dgriffinchess.wordpress.com/wp-content/uploads/2019/05/karpov-timman-montreal-1979.pdf",
      ...
      Candidate(
        ...
        source =
          "modules/commentary/tmp/frontier-proving-handoff-20260403.md / https://dgriffinchess.wordpress.com/wp-content/uploads/2021/09/karpov-unzicker-21st-olympiad-nice-1974.pdf",
        fen = "r1rq1bk1/Bnnb1p1p/3p2p1/1p1Pp3/1Pp1P3/2P2NNP/R1BQ1PP1/4R1K1 w - - 6 26",
        trigger = "e1a1",
        family = FamilyHint.BroaderB6,
        note =
          "Rea1 is root-best only after the exact Ne8-Nc7 corridor, but the defended branch still allows a downstream reroute and the same-game squeeze-style overlap stays unfit for reuse",
      ...
      Candidate(
        ...
        source =
          "modules/commentary/tmp/frontier-proving-handoff-20260403.md / https://www.latimes.com/archives/la-xpm-1985-09-16-mn-22008-story.html",
      ...
      Candidate(
        id = "boc_ke7",
        source = "local exact-FEN posture blocker archive",
        fen = "3R1k2/5ppp/ppb2n2/2r5/P1p5/2N1P1N1/1PP3PP/6K1 b - - 0 27",
        trigger = "f8e7",
        family = FamilyHint.PostureBlocker,
        note = "clean exact-FEN row kept only as a posture blocker, not a B6 route-chain witness",
      ...
      Candidate(
        ...
        trigger = "d2a5",
        family = FamilyHint.PostureBlocker,
        note = "queen-active posture shell; posture inflation blocks reuse",
      ...
      Candidate(
        ...
        source = "RouteNetworkBindProofBoundaryTest",
        fen = "2r2rk1/pp3pp1/2n1p2p/3p4/1p1P1P2/P1P1PN1P/1P4P1/2R2RK1 w - - 0 24",
        trigger = "c3b4",
      ...
      Candidate(
        ...
        source = "NamedRouteChainBindProofBoundaryTest",
        fen = "2r2rk1/pp3pp1/2n1p2p/3p4/1p1P1P2/P1P1PN1P/1P4P1/2R2RK1 w - - 0 24",
        trigger = "a3b4",
        family = FamilyHint.B4Blocker,
  ...
  @main def runNamedRouteSurfaceLedger(args: String*): Unit =
    val requestedIds =
      args
    ...
    ExactBoardEngineVerifier.resolvedEnginePath() match
      case None =>
        println("No engine available. Set STOCKFISH_BIN or AI_ACTIVE_CORPUS_ENGINE_PATH.")
  ...
  private def chooseAfterLine(
      candidate: Candidate,
      analysis: ExactBoardEngineVerifier.EngineAnalysis
  ): Option[ExactBoardEngineVerifier.EngineLine] =
  ...
  private def observedSameBranch(
      candidate: Candidate,
      afterLine: Option[ExactBoardEngineVerifier.EngineLine],
  ...
  private def defaultOutputPath(): Path =
    ...
    Paths.get("modules", "commentary", "tmp", s"named-route-validation-matrix-$stamp.tsv")
