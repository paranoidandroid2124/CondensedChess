...
class CommentaryQualityQuietSupportTest extends FunSuite:
  ...
  private def moveReviewEntry(
      ...
      commentary: String = "",
      moveReviewFallbackMode: String = MoveReviewFallbackMode.PlannerOwned,
    ...
    MoveReviewOutputEntry(
      ...
      surfaceReplayOutcome =
        Some(MoveReviewFallbackMode.replayOutcome(moveReviewFallbackMode)),
          ...
          beforeEntries =
            List(
              moveReviewEntry(
                ...
                moveReviewFallbackMode = MoveReviewFallbackMode.ExactFactual,
