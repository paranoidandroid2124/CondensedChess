...
class RealPgnNarrativeEvalReportMergeTest extends FunSuite:
  ...
  private def focusMoment(
    ...
    RealPgnNarrativeEvalRunner.FocusMomentReport(
      ...
      moveReviewCompensationSubtype = Some("queenside/target_fixing/intentionally_deferred/durable_pressure"),
      ...
      moveReviewPreparationCompensationSubtype = Some("queenside/target_fixing/intentionally_deferred/durable_pressure"),
      gameArcPayoffCompensationSubtype = Some("queenside/target_fixing/intentionally_deferred/durable_pressure"),
      moveReviewPayoffCompensationSubtype = Some("queenside/target_fixing/intentionally_deferred/durable_pressure"),
