      ...
      ctx.copy(
        ...
        mainStrategicPlans = List(
          PlanHypothesis(
            ...
            executionSteps = Nil,
            failureModes = Nil,
            viability = lila.commentary.model.authoring.PlanViability(0.73, "high", "coordinated"),
      ...
      ctx.copy(
        ...
        mainStrategicPlans = List(
          PlanHypothesis(
            ...
            executionSteps = Nil,
            failureModes = Nil,
            viability = lila.commentary.model.authoring.PlanViability(0.68, "medium", "queen active"),
            themeL1 = "opening_principles"
          )
        ),
        strategicPlanEvidence = PlanEvidenceEvaluator.StrategicPlanEvidenceView.empty,
