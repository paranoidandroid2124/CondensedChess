...
object ChronicleActivePlannerSliceRunner:
  ...
  final case class SliceSurfaceEntry(
      ...
      chronicleSelectedOwnerKind: Option[String],
      chronicleSelectedSource: Option[String],
      ...
      activeSelectedOwnerKind: Option[String],
      activeSelectedSource: Option[String],
      ...
      chronicleReplaySelectedOwnerKind: Option[String] = None,
      chronicleReplaySelectedSource: Option[String] = None,
      ...
      activeReplaySelectedOwnerKind: Option[String] = None,
      activeReplaySelectedSource: Option[String] = None,
  ...
  private final case class TargetReplayState(
      ...
      plannerAdmittedOwners: List[String],
      plannerDroppedOwners: List[String],
      plannerSupportMaterialSeparation: List[String],
      plannerProposedOwnerMappings: List[String],
      ...
      chronicleReplaySelectedOwnerKind: Option[String],
      chronicleReplaySelectedSource: Option[String],
      ...
      activeReplaySelectedOwnerKind: Option[String],
      activeReplaySelectedSource: Option[String],
  ...
  private def analyzeGame(
    ...
    val targetEntries = entries.map { entry =>
      ...
      SliceSurfaceEntry(
        ...
        chronicleSelectedOwnerKind = analyzed.flatMap(_.chronicleSelectedOwnerKind),
        chronicleSelectedSource = analyzed.flatMap(_.chronicleSelectedSource),
        ...
        activeSelectedOwnerKind = analyzed.flatMap(_.activeSelectedOwnerKind),
        activeSelectedSource = analyzed.flatMap(_.activeSelectedSource),
        ...
        plannerAdmittedOwners = analyzed.map(_.plannerAdmittedOwners).getOrElse(Nil),
        plannerDroppedOwners = analyzed.map(_.plannerDroppedOwners).getOrElse(Nil),
        plannerSupportMaterialSeparation = analyzed.map(_.plannerSupportMaterialSeparation).getOrElse(Nil),
        plannerProposedOwnerMappings = analyzed.map(_.plannerProposedOwnerMappings).getOrElse(Nil),
        ...
        plannerSelectedOwnerKind =
          targetReplay.flatMap(_.plannerSelectedOwnerKind).orElse(analyzed.flatMap(_.plannerSelectedOwnerKind)),
        plannerSelectedSource =
          targetReplay.flatMap(_.plannerSelectedSource).orElse(analyzed.flatMap(_.plannerSelectedSource)),
        ...
        chronicleReplaySelectedOwnerKind = targetReplay.flatMap(_.chronicleReplaySelectedOwnerKind),
        chronicleReplaySelectedSource = targetReplay.flatMap(_.chronicleReplaySelectedSource),
        ...
        activeReplaySelectedOwnerKind = targetReplay.flatMap(_.activeReplaySelectedOwnerKind),
        activeReplaySelectedSource = targetReplay.flatMap(_.activeReplaySelectedSource),
  ...
  private def analyzeTargetReplay(
    ...
    TargetReplayState(
      ...
      plannerAdmittedOwners = plannerTrace.admittedPlannerOwnerLabels,
      plannerDroppedOwners = plannerTrace.droppedPlannerOwnerLabels,
      plannerSupportMaterialSeparation = plannerTrace.supportMaterialSeparationLabels,
      plannerProposedOwnerMappings = plannerTrace.proposedOwnerMappingLabels,
      plannerDemotionReasons = plannerTrace.demotionReasons,
      plannerSelectedQuestion = plannerTrace.selectedQuestion.map(_.toString),
      plannerSelectedOwnerKind = plannerTrace.selectedPlannerOwnerKind.map(_.wireName),
      plannerSelectedSource = plannerTrace.selectedPlannerSource,
      chronicleReplayMode =
      ...
      chronicleReplaySelectedOwnerKind = chronicleSelection.map(_.primary.plannerOwnerKind.wireName),
      chronicleReplaySelectedSource = chronicleSelection.map(_.primary.plannerSource),
      ...
      activeReplaySelectedOwnerKind = activeSelection.map(_.primary.plannerOwnerKind.wireName),
      activeReplaySelectedSource = activeSelection.map(_.primary.plannerSource),
      ...
      renderArtifact
        ...
        .getOrElse(
          ChronicleQuietSupportTrace(
            ...
            runtimeSelectedOwnerKind = fallbackTrace.gate.selectedOwnerKind,
            runtimeSelectedSource = fallbackTrace.gate.selectedSource,
  ...
  private[tools] def analyzeMoment(
    ...
    MomentSurfaceState(
      ...
      chronicleSelectedOwnerKind = chronicleSelection.map(_.primary.plannerOwnerKind.wireName),
      chronicleSelectedSource = chronicleSelection.map(_.primary.plannerSource),
      ...
      activeSelectedOwnerKind = activeSelection.map(_.primary.plannerOwnerKind.wireName),
      activeSelectedSource = activeSelection.map(_.primary.plannerSource),
      ...
      plannerAdmittedOwners = plannerTrace.map(_.admittedPlannerOwnerLabels).getOrElse(Nil),
      plannerDroppedOwners = plannerTrace.map(_.droppedPlannerOwnerLabels).getOrElse(Nil),
      plannerSupportMaterialSeparation = plannerTrace.map(_.supportMaterialSeparationLabels).getOrElse(Nil),
      plannerProposedOwnerMappings = plannerTrace.map(_.proposedOwnerMappingLabels).getOrElse(Nil),
      ...
      plannerSelectedOwnerKind = plannerTrace.flatMap(_.selectedPlannerOwnerKind.map(_.wireName)),
      plannerSelectedSource = plannerTrace.flatMap(_.selectedPlannerSource),
    ...
    visibleMoments.flatMap { moment =>
      ...
      Option.when(hasChronicleAnomaly || hasActiveAnomaly) {
        Json.obj(
          ...
          "chronicleSelectedOwnerKind" -> moment.chronicleSelectedOwnerKind,
          "chronicleSelectedSource" -> moment.chronicleSelectedSource,
          "activeMode" -> moment.activeMode,
          "activePrimaryKind" -> moment.activePrimaryKind,
          "activeSelectedOwnerKind" -> moment.activeSelectedOwnerKind,
          "activeSelectedSource" -> moment.activeSelectedSource,
