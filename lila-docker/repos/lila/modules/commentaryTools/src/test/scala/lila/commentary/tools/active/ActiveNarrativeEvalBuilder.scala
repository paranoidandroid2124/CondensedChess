...
object ActiveNarrativeEvalBuilder:
  ...
  private val DefaultOutPath = Paths.get("modules/commentary/docs/ActiveNarrativePlayerCorpus_20260311.evals.json")
  private val DefaultDepth = 12
  private val DefaultMultiPv = 2
  private val DefaultTimeoutMs = 30000L
  private val EngineEnv = "AI_ACTIVE_CORPUS_ENGINE_PATH"
