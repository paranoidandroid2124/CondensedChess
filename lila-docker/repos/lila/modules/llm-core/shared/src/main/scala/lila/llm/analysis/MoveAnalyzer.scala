...
import lila.llm.model.strategic.{ VariationLine, VariationTag, CounterfactualMatch }
...
object MoveAnalyzer:
  ...
  def createMatch(
    ...
    val userMotifs = tokenizePv(fen, userLine.moves)
    val bestMotifs = tokenizePv(fen, bestLine.moves)
