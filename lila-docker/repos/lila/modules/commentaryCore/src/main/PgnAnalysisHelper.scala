...
object PgnAnalysisHelper:
  ...
  private def convertUciToSan(fen: String, uciMove: String): Option[String] =
    lila.commentary.analysis.NarrativeUtils.uciToSan(fen, uciMove)
