...
import chess.Color
import lila.commentary.analysis.L3.PawnPlayAnalysis
import lila.commentary.model.{ Motif, PlanMatch }
import lila.commentary.model.structure.{ AlignmentBand, CenterState, PlanAlignment, StructureId, StructureProfile, StructuralPlaybookEntry }
