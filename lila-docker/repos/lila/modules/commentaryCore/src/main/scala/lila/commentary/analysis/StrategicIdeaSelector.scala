...
import lila.commentary.analysis.L3.{ ThreatAnalysis, ThreatKind }
import lila.commentary.*
import lila.commentary.model.{ Motif, PlanId, PlanMatch, StrategicPlanExperiment }
import lila.commentary.model.strategic.{ PositionalTag, PreventedPlan, TheoreticalOutcomeHint, WeakComplex }
...
private[commentary] object StrategicIdeaSelector:
  ...
  private def isThreatDrivenCounterplaySuppression(
      ...
      opponentPawnAnalysis: Option[lila.commentary.analysis.L3.PawnPlayAnalysis],
  ...
  private def preventsCounterBreak(
      ...
      opponentPawn: lila.commentary.analysis.L3.PawnPlayAnalysis
  ): Boolean =
