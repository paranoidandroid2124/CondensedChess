...
import chess.Color
import lila.commentary.model.authoring.{ AuthorQuestion, PlanHypothesis, QuestionEvidence }
...
case class NarrativeContext(
  ...
  counterfactual: Option[lila.commentary.model.strategic.CounterfactualMatch] = None,
  ...
  plans: PlanTable,
  planContinuity: Option[lila.commentary.model.strategic.PlanContinuity] = None,
  ...
  // === ENGINE EVIDENCE ===
  engineEvidence: Option[lila.commentary.model.strategic.EngineEvidence] = None,
  ...
  strategicSalience: lila.commentary.model.strategic.StrategicSalience = lila.commentary.model.strategic.StrategicSalience.High,
...
/** Exposes ExtendedAnalysisData semantic fields to AI. */
