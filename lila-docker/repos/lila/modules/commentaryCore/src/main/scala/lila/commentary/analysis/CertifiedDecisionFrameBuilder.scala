...
private[commentary] enum CertifiedDecisionFrameAxis:
  case Intent
  case Battlefront
  case Urgency

private[commentary] enum CertifiedUrgencyClass:
  case Immediate
  case Pressing
  case Slow

private[commentary] enum BattlefrontAnchorClass:
  case None
  case MoveLocal
  case ProbeBacked

private[commentary] final case class CertifiedDecisionSupport(
...
private[commentary] final case class CertifiedDecisionFrame(
