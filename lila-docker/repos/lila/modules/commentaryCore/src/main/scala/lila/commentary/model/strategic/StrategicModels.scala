...
case class PreventedPlan(
    ...
    sourceScope: lila.commentary.model.FactScope = lila.commentary.model.FactScope.Now,
...
object StrategicSalience:
  def calculate(
      transitionType: lila.commentary.model.TransitionType,
      consecutivePlies: Int,
      evalDeltaCp: Int,
      themeMaxShare: Double = 1.0
  ): StrategicSalience =
    import lila.commentary.model.TransitionType.*
...
case class CounterfactualMatch(
    ...
    bestMove: String,
    cpLoss: Int,
    missedMotifs: List[lila.commentary.model.Motif],
    userMoveMotifs: List[lila.commentary.model.Motif],
    severity: String,
    userLine: lila.commentary.model.strategic.VariationLine,
    causalThreat: Option[lila.commentary.analysis.ThreatExtractor.CausalThreat] = None,
    bestLine: lila.commentary.model.strategic.VariationLine = lila.commentary.model.strategic.VariationLine(Nil, 0)
)
...
case class AnalyzedCandidate(
    ...
    motifs: List[lila.commentary.model.Motif],
    ...
    facts: List[lila.commentary.model.Fact] = Nil, // Verified Facts
    line: VariationLine
)
