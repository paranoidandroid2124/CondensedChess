...
private[commentary] final class OpeningRouteCatalog private (
...
private[commentary] object OpeningRouteCatalog:
  ...
  private val ResourcePath = "lila/commentary/openings/opening_routes.tsv"
  ...
  private[analysis] def normalize(raw: String): String =
