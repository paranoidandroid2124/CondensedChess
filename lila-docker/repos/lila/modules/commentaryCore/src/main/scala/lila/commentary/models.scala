...
case class CommentRequest(
    ...
    planStateToken: Option[lila.commentary.analysis.PlanStateTracker] = None,
...
case class CommentResponse(
  ...
  variations: List[lila.commentary.model.strategic.VariationLine] = Nil,
