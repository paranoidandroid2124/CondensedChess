...
class MarkdownTest extends munit.FunSuite:
  ...
  val render: Markdown => Html =
    new MarkdownRender(assetDomain = AssetDomain("chesstory.com").some, header = true)("test")
...
"""
  ...
  test("markdown image whitelist pass - exact domain match to AssetDomain conf"):
    assertEquals(
      render(Markdown("![image](https://chesstory.com/image.png)")),
      Html("""<p><img src="https://chesstory.com/image.png" alt="image" /></p>
""")
    )
