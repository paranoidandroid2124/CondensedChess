 ...
 *
 * Usage:
 *   sbt "llm/Test/runMain lila.llm.tools.PawnStructureGoldsetSampler"
 *   sbt "llm/Test/runMain lila.llm.tools.PawnStructureGoldsetSampler --out=modules/llm/docs/PawnStructureCandidates.jsonl --limit=600"
 */
