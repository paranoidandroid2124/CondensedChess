...
/** Audit helper to inspect per-ply bookmaker commentary and rough token risk.
  *
  * Usage:
  *   sbt "llm/Test/runMain lila.llm.tools.PlyCommentaryAudit"
  *   sbt "llm/Test/runMain lila.llm.tools.PlyCommentaryAudit \"1. d4 Nf6 2. c4 e6 3. Nf3 d5 4. g3 *\""
  *   sbt "llm/Test/runMain lila.llm.tools.PlyCommentaryAudit --opening \"Sicilian Defense\" \"1. e4 c5 2. Nf3 d6 3. d4 cxd4 *\""
  *   sbt "llm/Test/runMain lila.llm.tools.PlyCommentaryAudit --allow-llm --opening \"Catalan Opening\" \"1. d4 Nf6 2. c4 e6 3. Nf3 d5 4. g3 *\""
  */
